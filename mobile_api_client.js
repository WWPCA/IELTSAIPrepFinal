...
class MobileAPIClient {
    constructor() {
        // All API calls now go through www.ieltsaiprep.com (API Gateway custom domain)
        this.apiEndpoint = 'https://www.ieltsaiprep.com';
        this.novaSonicEndpoint = 'https://www.ieltsaiprep.com';
    ...
    getRegionalEndpoint() {
        // All regions now use the same endpoint through API Gateway custom domain
