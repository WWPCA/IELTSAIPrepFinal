...
{{
    ...
    def _get_writing_rubric(self, assessment_type: str) -> Dict[str, Any]:
        ...
        # Add task-specific metadata to rubric
        rubric_with_meta: Dict[str, Any] = dict(base_rubric)
        if "task1" in assessment_type.lower():
            rubric_with_meta["task_type"] = "Report writing - describe visual information"
            rubric_with_meta["min_words"] = 150
        else:
            rubric_with_meta["task_type"] = "Essay writing - present arguments and opinions"
            rubric_with_meta["min_words"] = 250
            
        return rubric_with_meta
