...
class GeminiLiveServiceSmart:
    ...
    Supports 21 global regions with automatic routing
    """
    ...
    def __init__(
        ...
        """
        Initialize Gemini service with optional regional routing
        ...
        logger.info(f"Gemini Live Smart Selection initialized - project: {self.project_id}, region: {self.region}")
